...
namespace Aula09.Comum.NotificationPattern
{
    public class NotificationResult
    {
        ...
        public IEnumerable<NotificationError> Errors => _errors;
        ...
        public NotificationResult Add(NotificationResult notificationResult, params NotificationError[] validationResults)
        {
